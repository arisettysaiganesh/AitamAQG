   ...
   if(isset($_POST["submit"]))
{
    ...
    if($regulation_id==""||$regulation_name==""||$degree_id=="")
    {
        $a_err = "Please enter all credentials";			
    }
    else
    {
        $query="Insert into regulations values('$regulation_id','$regulation_name','$degree_id');";
...
<div class="affiliation-form">
    <form action="regulations.php" method="post">
        ...
        <label for="regulation_name">Regulation Name:</label>
        <input type="text" id="regulation_name" name="regulation_name" placeholder="Enter Regulation Name" required>
